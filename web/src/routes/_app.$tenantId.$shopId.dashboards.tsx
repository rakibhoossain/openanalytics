...
function Component() {
  ...
  const dashboards = Array.isArray(query.data) ? query.data : [];
      ...
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 md:grid-cols-3">
        {dashboards.map((item) => {
          ...
          const visibleReports = reports.slice(
            0,
            reports.length > 6 ? 5 : 6,
          );
          return (
            <Card key={item.id} hover>
              <div>
                <Link
                  to="/$tenantId/$shopId/dashboards/$dashboardId"
                  params={{
                ...
                >
                  ...
                  >
                    {visibleReports.map((report: any) => {
                      ...
                      const Icon = iconMap[report.chartType] || BarChartHorizontalIcon;
