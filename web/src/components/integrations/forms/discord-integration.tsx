...
async function sendTestDiscordNotification(webhookUrl: string) {
  try {
    return await fetch(webhookUrl, {
      method: 'POST',
      headers: { 'Content-Type': 'application/json' },
      body: JSON.stringify({
        content: '**🧪 Test Notification**\\nIf you can read this, your webhook is functioning correctly!\\n',
        username: 'OpenAnalytics Notifications',
      }),
    });
  } catch {
    return { ok: false };
