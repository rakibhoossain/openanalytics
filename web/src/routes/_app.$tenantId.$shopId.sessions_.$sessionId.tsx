...
function Component() {
  ...
  const organizationId = params.tenantId || params.organizationId;
          ...
          <Widget className="w-full">
            ...
            <KeyValueGrid
              ...
              data={[
                ...
                { name: 'createdAt', value: formatDateTime(session.createdAt) },
                { name: 'endedAt', value: formatDateTime(session.endedAt) },
            ...
            <Widget className="w-full">
              ...
              <WidgetBody className="p-0">
                <Link
                  ...
                  to="/$tenantId/$shopId/profiles/$profileId"
                >
            ...
            <Widget className="w-full">
              ...
              <WidgetBody className="p-0">
                {sessionGroups.map((group) => (
                  <div
                    key={group.id}
                    className="row items-center gap-3 p-4"
                  >
